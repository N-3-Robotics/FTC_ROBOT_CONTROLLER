...
public class Drivetrain implements Subsystem {
    ...
    public void onInit(HardwareMap hardwareMap, Telemetry telemetry) {
        ...
        this.rightFrontMotor = (DcMotorEx) hardwareMap.get(DcMotor.class, "FR");
        this.leftFrontMotor = (DcMotorEx) hardwareMap.get(DcMotor.class, "FL");
        this.leftBackMotor = (DcMotorEx) hardwareMap.get(DcMotor.class, "BL");
        this.rightBackMotor = (DcMotorEx) hardwareMap.get(DcMotor.class, "BR");
